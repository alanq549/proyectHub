  ...
  <div class="tw-py-2 tw-max-w-7xl tw-mx-auto tw-space-y-6">
    <div class="tw-flex tw-flex-col sm:tw-flex-row tw-justify-between tw-items-start sm:tw-items-center tw-gap-4">
      <div>
        ...
        <p class="tw-text-on-surface-variant tw-text-xs tw-mt-1">Control centralizado de fechas, estados y recepción de proyectos.</p>
      </div>
    ...
    <div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 lg:tw-grid-cols-4 tw-gap-4">
      <AppCard variant="glass" class="tw-flex tw-items-center tw-justify-between">
        ...
        <div class="tw-w-10 tw-h-10 tw-rounded-2xl tw-bg-surface-container tw-text-on-surface-variant tw-flex tw-items-center tw-justify-center tw-shrink-0">
      ...
      <AppCard variant="glass" class="tw-flex tw-items-center tw-justify-between">
        ...
        <div class="tw-w-10 tw-h-10 tw-rounded-2xl tw-bg-success-bg tw-text-success tw-flex tw-items-center tw-justify-center tw-shrink-0">
    ...
    <div v-if="loading" class="tw-flex tw-flex-col tw-items-center tw-justify-center tw-py-20 tw-gap-3">
      <svg class="tw-animate-spin tw-h-8 tw-w-8 tw-text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    <AppCard v-else-if="calls.length === 0" variant="glass" class="tw-text-center tw-py-16 tw-px-4 tw-border-dashed tw-flex tw-flex-col tw-items-center tw-justify-center">
      <div class="tw-w-12 tw-h-12 tw-rounded-2xl tw-bg-surface-container tw-text-outline tw-flex tw-items-center tw-justify-center tw-mb-3">
